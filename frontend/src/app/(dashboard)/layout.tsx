      ...
      <main className="flex-1 flex flex-col overflow-hidden relative">
        ...
        <header className="h-20 flex items-center px-6 border-b border-slate-200 bg-white/95 backdrop-blur-sm sticky top-0 z-30">
          <div className="flex items-center gap-4 flex-1">
             ...
             <Sheet open={open} onOpenChange={setOpen}>
               <SheetTrigger asChild>
                 <Button variant="ghost" size="icon" className="xl:hidden hover:bg-slate-100 border border-slate-200 cursor-pointer">
          ...
          <div className="flex items-center gap-4">
             <Button variant="ghost" size="icon" className="relative hover:bg-slate-100 rounded-full border border-slate-200 cursor-pointer">
             ...
             <DropdownMenu>
                ...
                <DropdownMenuContent align="end" className="w-56 rounded-2xl border-slate-200 p-2 shadow-xl animate-in fade-in-0 zoom-in-95">
                   ...
                   <DropdownMenuItem className="rounded-xl cursor-pointer font-bold text-slate-700 focus:bg-slate-50 focus:text-emerald-600 gap-3 py-2.5">
                   ...
                   <DropdownMenuItem 
                      ...
                      className="rounded-xl cursor-pointer font-bold text-rose-600 focus:bg-rose-50 focus:text-rose-700 gap-3 py-2.5"
                   >
        ...
        {/* Content */}
        <div className="flex-1 overflow-y-auto p-5 md:p-10 bg-background emerald-scrollbar">
