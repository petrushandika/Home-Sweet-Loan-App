              ...
              <div className="flex items-center gap-4">
                ...
                <Sheet open={open} onOpenChange={setOpen}>
                  <SheetTrigger asChild>
                    <Button variant="ghost" size="icon" className="md:hidden rounded-xl transition-all duration-300 active:scale-95 border-none">
                 ...
                 <div className="hidden md:block">
                    <DropdownMenu>
                       <DropdownMenuTrigger asChild>
                          <Button variant="ghost" size="icon" className="rounded-xl relative hover:bg-slate-100 dark:hover:bg-slate-800 group transition-all duration-300 hover:shadow-sm active:scale-95 border-none">
                       ...
                       <DropdownMenuContent align="end" className="w-80 rounded-2xl border-border bg-white dark:bg-slate-900 p-0 shadow-xl animate-in fade-in-0 zoom-in-95 duration-300 overflow-hidden">
                          ...
                          <div className="p-3 border-t border-border bg-slate-50/50 dark:bg-slate-900 text-center">
                             <button className="text-xs font-bold text-emerald-600 hover:text-emerald-700 transition-colors border-none bg-transparent cursor-pointer">Mark all as read</button>
                          </div>
                       </DropdownMenuContent>
                    </DropdownMenu>
                 </div>
                       ...
                       <DropdownMenuTrigger asChild>
                          <div className="flex items-center gap-3 pl-3 pr-1 py-1 rounded-2xl border border-border bg-white/50 dark:bg-slate-800/30 hover:bg-white dark:hover:bg-slate-800 hover:border-emerald-500/30 hover:shadow-sm transition-all duration-300 cursor-pointer group active:scale-[0.98]">
                             <div className="flex flex-col items-end">
                                <span className="text-[11px] font-black text-slate-900 dark:text-white uppercase tracking-tight">{user?.name || "User HSL"}</span>
                          ...
                          <div className="flex flex-col gap-6">
                             <div className="flex items-center gap-4 bg-white dark:bg-slate-800 p-4 rounded-3xl shadow-sm border border-border">
                                <div className="w-16 h-16 rounded-2xl border-2 border-emerald-100 dark:border-emerald-800 p-0.5 overflow-hidden bg-white dark:bg-slate-900">
                                   <img 
                                      src={user?.avatarUrl || "https://images.unsplash.com/photo-1535713875002-d1d0cf377fde?auto=format&fit=crop&w=200&h=200&q=80"} 
                                      alt="Profile" 
                                      className="w-full h-full rounded-xl object-cover"
                                   />
                                </div>
                                <div className="flex flex-col">
                                   <span className="text-lg font-black text-slate-900 dark:text-white uppercase tracking-tight">{user?.name || "User HSL"}</span>
